...
# 权重基于真实BGP分配密度，热门段权重更高
WEIGHTED_FIRST_OCTETS = [
    (1, 1), (2, 1), (3, 2), (4, 3), (5, 3), (6, 2), (7, 2), (8, 4),
    (9, 3), (10, 0), (11, 2), (12, 3), (13, 2), (14, 2), (15, 2), (16, 2),
    ...
    (163, 3), (164, 3), (165, 3), (166, 3), (167, 3), (168, 0), (169, 0), (170, 3),
    (171, 3), (172, 0), (173, 3), (174, 3), (175, 3), (176, 3), (177, 3), (178, 3),
    (179, 3), (180, 3), (181, 3), (182, 3), (183, 3), (184, 3), (185, 4), (186, 3),
    (187, 3), (188, 3), (189, 3), (190, 3), (191, 3), (192, 0), (193, 3), (194, 3),
    (195, 3), (196, 3), (197, 3), (198, 0), (199, 3), (200, 3), (201, 3), (202, 3),
    (203, 0), (204, 3), (205, 3), (206, 3), (207, 3), (208, 3), (209, 3), (210, 3),
...
def random_public_ip() -> str:
    """生成一个随机公网 IP（按真实BGP分布加权，热门段命中率更高）"""
    while True:
